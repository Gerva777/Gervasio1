...
lyr_SITIOS_SELEC_3.set('fieldLabels', {'Name': 'no label', 'visibility': 'inline label - always visible', 'X_coord': 'inline label - always visible', 'Y_coord': 'inline label - always visible', 'AsistAnual': 'inline label - always visible', 'Ninos': 'inline label - always visible', 'Adultos': 'inline label - always visible', 'Hombres': 'inline label - always visible', 'Mujeres': 'inline label - always visible', 'Video': 'inline label - always visible', });
